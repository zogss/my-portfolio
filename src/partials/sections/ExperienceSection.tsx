  ...
  return (
    <section
      ...
      <div className="flex w-full flex-col items-center gap-2.5 self-stretch">
        <div className="relative flex w-full items-center justify-center gap-6 py-10 md:py-[4.5rem]">
          ...
          <div className="h-10 w-full text-center sm:h-12 md:h-16">
            <h2 className="absolute left-1/2 w-full -translate-x-1/2 whitespace-nowrap text-4xl font-black uppercase leading-[100.5%] tracking-[.08rem] text-white/80 mix-blend-overlay text-shadow-primary sm:text-5xl md:w-auto md:text-[4rem]">
              {t('experience')}
            </h2>
          </div>
        </div>
      ...
      <div className="relative flex w-full justify-center">
        <div className="absolute -top-8 left-0 h-[calc(100%+4rem)] w-1 -translate-x-1/2 bg-[linear-gradient(180deg,#08070c22_0%,#663BC3cc_20%,#663BC3cc_70%,#08070C_120%)] shadow-secondary lg:left-1/2" />
        <div className="relative w-full lg:-space-y-4">
          {experiences.map((exp, index) => (
            <motion.div
              ...
              <div className="absolute left-0 top-1/2 z-[1] size-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/80 shadow-white-sm lg:left-1/2" />
            </motion.div>
          ))}
        </div>
      </div>
