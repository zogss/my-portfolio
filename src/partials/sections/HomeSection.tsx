...
const HomeSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-[1] flex w-full flex-col items-center justify-start gap-16 lg:items-start lg:pb-10 2xl:pb-16">
        <div className="flex flex-col items-start justify-start gap-6">
          <div className="flex h-32 w-full mix-blend-overlay lg:h-16">
            <h2 className="absolute left-1/2 -translate-x-1/2 text-center text-[4rem] font-black leading-[100.5%] tracking-[.08rem] text-white/80 backdrop-blur-[.1766rem] text-shadow-primary lg:left-auto lg:translate-x-0 lg:text-start">
      ...
      <div className="absolute right-[5%] hidden h-auto w-[43.75rem] justify-end rounded-2xl bg-gradient-to-l from-black/30 to-black/0 md:translate-y-[25%] lg:flex lg:translate-y-[12%] xl:right-[6%] xl:translate-y-[9%] 2xl:right-[12%] 2xl:translate-y-[7%]">
        <StaticImage
