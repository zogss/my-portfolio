...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <div className="relative flex h-64 w-full flex-col items-center justify-center py-10 md:h-80 md:py-16 lg:h-115 lg:py-24">
      ...
      {!hideOverlay && (
        ...
        >
          <div className="from-charcoal-black-700 h-225 w-425 rounded-full bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] via-transparent to-transparent" />
        </div>
      )}
      <div className="from-charcoal-black-700 to-charcoal-black-700/20 absolute inset-x-0 top-0 z-[-2] h-18 bg-linear-to-b" />
      <div className="from-charcoal-black-700 via-charcoal-black-700/60 absolute inset-x-0 bottom-0 z-[-2] h-40 bg-linear-to-t to-transparent" />
    </div>
  );
};
