...
const AboutSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-[1] flex w-full flex-col items-center gap-10 md:gap-12 xl:flex-row xl:items-start xl:justify-center 2xl:gap-16">
        <AnimationContainer
          reverse
          orientation="horizontal"
          className="relative size-auto shrink-0 p-3"
        >
          <Image
            src={myImage}
        ...
        <AnimationContainer
          orientation="horizontal"
          className="flex h-auto w-full flex-col items-center text-sm text-zinc-500 md:text-base lg:text-lg"
        >
