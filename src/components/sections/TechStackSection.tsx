  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center gap-2.5 self-stretch">
        <div className="relative flex w-full items-center justify-center gap-6 py-10 md:py-18">
          <TitleEclipse className="absolute top-1/2 left-1/2 h-125 -translate-x-1/2 -translate-y-1/2 lg:h-200" />
