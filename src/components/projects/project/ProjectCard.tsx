        ...
        >
          <div className="group/projectCard bg-midnight-slate-700 relative overflow-hidden rounded-md p-2.5 transition-colors duration-500 hover:bg-neutral-300/20 md:p-3.5">
            <div className="z-1 flex flex-col items-center gap-2 self-stretch md:gap-3">
              <div className="group/projectImg relative max-h-47.5 shrink-0 overflow-hidden rounded border border-transparent transition-colors duration-500 group-hover/projectCard:border-neutral-400/20 sm:h-47.5 sm:max-h-max 2xl:h-51.25">
                <Image
                  src={image}
                  alt={t(alt)}
                  width={2400}
                  height={1200}
                  className="aspect-18/9 max-h-47.5 w-full [transition:transform_5000ms_cubic-bezier(0.7,0,0.7,1.01),max-height_200ms] hover:transform-[scale(150%)] sm:w-auto 2xl:max-h-51.25"
                />
